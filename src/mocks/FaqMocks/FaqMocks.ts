...
export const faqlist: FaqList[] = [
  {
    ...
    title: 'обязательные',
    description:
      'Сначала учитываются те, что не меняются от месяца к месяцу: коммунальные услуги или аренда, транспорт, необходимое лечение. Остаток – на питание, одежду, другие повседневные траты.',
  },
  {
    percentage: '30%',
    title: 'хотелки',
    description:
      'Расходы, без которых обойтись можно, но не хочется: развлечения, хобби, путешествия.',
  },
  {
    percentage: '20%',
    title: 'накопления',
...
export const faqlist2: FaqList2[] = [
  {
    ...
    description:
      'Это бюджет «на жизнь»: квартплата, еда, проезд, лекарства и все, без чего не обойтись. Их откладываем в первую очередь.',
  },
  {
    percentage: '10%',
    title: 'забота о себе',
    description:
      'В эту группу входит все, что доставляет удовольствие: хобби, танцы в клубе, походы в театр, массаж, посиделки в кофейне.',
  },
  {
    percentage: '10%',
    title: 'образование',
  ...
  },
  {
    ...
    title: 'копилка',
    description:
      'Десятая часть доходов откладывается на что-то конкретное или формирует подушку безопасности.',
  },
  {
    percentage: '10%',
